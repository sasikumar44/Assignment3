...
public class Q3_3_GetDistance extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Q3_3_GetDistance frame = new Q3_3_GetDistance();
	...
	public Q3_3_GetDistance() {
		...
		btnGetDistance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Q3_2_StoreDistance q = new Q3_2_StoreDistance();
				
				label_1.setText(Integer.toString(q.getDistance(value1, value2)));
