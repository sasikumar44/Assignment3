...
public class Q6_4_SaveQuestionDb extends JFrame {
	...
	public static void main(String args[]) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Q6_4_SaveQuestionDb fr = new Q6_4_SaveQuestionDb();
					fr.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public Q6_4_SaveQuestionDb() {
		...
		b1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				choice = String.join(",", c1,c2,c3);
				
				Q6_Services s = new Q6_Services();
				s.saveData(question, choice, correct);
